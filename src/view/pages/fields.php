            ...
            <?php foreach($fields as $field):  ?>
                <tr>
                    ...
                    <td class="align-middle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#9b4dca" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    <section class="col-sm">
        ...
        <form action="/exercises/<?= $this->variables['exerciseId'] ?> /fields" method="post" >
            <div class="field">
                ...
                <input type="text" id="name" name="name" maxlength="512" class="form-control"><br>
            </div>
