                ...
                foreach ($fields as $field): ?>
                    <tr>
                        ...
                        <td class="align-middle">
                            <a data-confirm="Are you sure?" title="Destroy" rel="nofollow" data-method="delete" href="/exercises/<?= $this->variables['exerciseId']; ?>/fields/<?= $field->id ?>/update">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#9b4dca"
                            ...
                            <a data-confirm="Are you sure?" title="Destroy" rel="nofollow" data-method="delete" href="/exercises/<?= $this->variables['exerciseId']; ?>/fields/<?= $field->id ?>/delete">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#9b4dca" class="bi bi-trash-fill" viewBox="0 0 16 16">
