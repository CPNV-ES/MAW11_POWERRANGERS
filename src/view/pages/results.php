...
?>
    <table class="table w-100">
        ...
        <tbody>
        <?php for ($i = 0 ; $i < count($fulfillments); $i++) : ?>
        <tr>
            <td><a class="icon text-decoration-none" href="/exercises/29/fulfillments/376"><?= $fulfillments[$i]->dateTime ?></a></td>
            <?php foreach ($answers[$i] as $answer) : ?>
                <?php if(strlen($answer->value) == 0) : ?>
                ...
                <?php elseif(strlen($answer->value) >= 10) : ?>
                <td>
